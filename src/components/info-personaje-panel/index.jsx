...
const PanelPorPersonaje = () => {
  ...
  return (
    <div className="contenedorPrincipalInfoPersonaje">
              ...
              tablaDatos.map((elem, index) => (
                <React.Fragment key={`personaje-${index}`}>
                  <tr className="mmorpg-card">
                    ...
                    <td className="col-reputacion">Asesino: {elem.AsesinoB}</td>
                  </tr>
                  <tr className="mmorpg-card">
                    <td>
                      Exp:{" "}
                  ...
                  <tr className="mmorpg-card">
                    ...
                    <td className="col-reputacion">Bandido: {elem.BandidoB}</td>
                  </tr>
                  <tr className="mmorpg-card">
                  ...
                  <tr className="mmorpg-card">
                    ...
                    <td className="col-reputacion">Ladrón: {elem.LadronesB}</td>
                  </tr>
                  <tr className="mmorpg-card">
                    <td>
